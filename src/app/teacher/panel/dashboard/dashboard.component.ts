...
import { SubjectGradeBarComponent } from '../../../student/panel/student-component/subject-grade-bar/subject-grade-bar.component';
...
@Component({
  ...
  imports: [TableComponent, CommonModule, SubjectGradeBarComponent, PanelHeaderComponent],
